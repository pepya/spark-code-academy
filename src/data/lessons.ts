...
export const lessonModules: LessonModule[] = [
  {
    ...
    emoji: "🐱",
    description: "Meet Scratch and ScratchJr — learn the fundamentals",
    lessonIds: ["hello-scratch", "move-scratch-cat", "draw-with-code", "scratchjr-week1", "scratchjr-week2"],
  },
  {
    id: "scratch-create",
    title: "Create & Play",
    emoji: "🎮",
    description: "Make music, stories, games, and dance shows",
    lessonIds: ["make-music", "interactive-story", "first-game", "scratchjr-week3", "scratchjr-week4", "scratchjr-week5"],
  },
  {
    id: "scratch-advanced",
    title: "Level Up",
    emoji: "🚀",
    description: "Master animations, loops, advanced blocks, and final projects",
    lessonIds: ["animations", "loops-conditions", "advanced-blocks", "scratchjr-week6"],
  },
];
